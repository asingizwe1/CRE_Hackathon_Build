...
export const saveUserPhoneRemote = async (userId: string, phone: string) => { await fetch(`${import.meta.env.VITE_API_BASE}/user`, { method: "POST", headers: { "Content-Type": "application/json", "x-api-key": import.meta.env.VITE_RESOLVER_API_KEY, }, body: JSON.stringify({ userId, phone }), }); };